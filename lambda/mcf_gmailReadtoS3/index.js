...
exports.handler = async (event, context) => {
  try {
    ...
    console.log(`subject:"Fichero de ventas del" has:attachment after:${date}`)

    // Search parameters
    const searchQuery = `subject:"Fichero de ventas del" has:attachment from:mcf.usera@gmail.com`; // Adjust as needed
